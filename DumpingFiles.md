...
1) Boot your switch in RCM mode and launch the hekate payload (**you don't need the whole atmosphere cfw, we are just using hekate to get some keys**), if you have autoboot enabled press VOL- during boot to enter the menu.
